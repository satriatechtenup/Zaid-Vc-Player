...
BOT_TOKEN = getenv("BOT_TOKEN", "7245663010:AAEjpf2nLUcelttirNc1aanZi62Z2Ae4_PE")
BOT_NAME = getenv("BOT_NAME", "bot musik")
...
OWNER_NAME = getenv("OWNER_NAME", "sat")
OWNER_USERNAME = getenv("OWNER_USERNAME", "YouFreind")
ALIVE_NAME = getenv("ALIVE_NAME", "sat")
BOT_USERNAME = getenv("BOT_USERNAME", "Zaid2_Robot")
OWNER_ID = getenv("OWNER_ID", "1669178360")
ASSISTANT_NAME = getenv("ASSISTANT_NAME", "sat_Assistant")
